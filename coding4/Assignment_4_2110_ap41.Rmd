...
We can rewrite the objective function as follows by re factoring and dropping some constants, namely  $\sqrt{(2 \pi)^p | \Sigma| }$.
...
$$
\begin{aligned}
\frac{\partial }{\partial u_k} g(p_{1:G}, \mu_{1:G}, \Sigma) = & \frac{\partial }{\partial u_k} \Big  [ - \frac{1}{2} \sum_{i=1}^n \sum_{k=1}^G p_{ik}(x- \mu_k)^t \Sigma^{-1} (x - \mu_k) \Big ] \\
...
$$
\begin{aligned}
\frac{\partial }{\partial \Sigma_k} g(p_{1:G}, \mu_{1:G}, \Sigma) = & \frac{\partial }{\partial \Sigma_k} \Big  [ - \frac{1}{2} \sum_{i=1}^n \sum_{k=1}^G p_{ik}  \log|\Sigma_k| (x- \mu_k)^t \Sigma_k^{-1} (x - \mu_k) \Big ] \\
